  ...
  return (
    <div className="relative dark:text-gray-700" x-data="{ dropdownOpen: false, notifying: true }">
      <Link
        ...
        className="p-1 flex items-center rounded-lg cursor-pointer bg-slate-200"
        to="#"
      >
       <BsChatDots
                     size={20} className='font-medium text-gray-600'/>
      </Link>
      ...
      <div
        ...
        className={`absolute md:-right-16 right-0 mt-2.5 flex h-96 flex-col 
        w-[19rem]
